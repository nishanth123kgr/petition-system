...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-950 via-slate-900 to-blue-950 text-slate-200">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-20 left-[10%] w-72 h-72 bg-blue-600/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-40 right-[5%] w-96 h-96 bg-blue-600/10 rounded-full blur-[120px]" />
      </div>
      ...
      <header className="border-b border-slate-800/60 bg-slate-900/80 backdrop-blur-xl sticky top-0 z-50 shadow-lg shadow-slate-950/20">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <Link href="/" className="flex items-center gap-2">
            <div className="h-9 w-9 rounded-md bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm shadow-blue-900/30">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth/register">
              <Button className="relative overflow-hidden group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white shadow-lg shadow-blue-900/30 transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="max-w-xl">
              <span className="inline-block px-3 py-1 rounded-full text-sm font-medium bg-blue-900/40 text-blue-200 mb-6 border border-blue-700/40">
                Streamlined Petition Management
              </span>
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Making civic engagement <span className="bg-gradient-to-r from-blue-400 to-blue-300 text-transparent bg-clip-text">simple and effective</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/auth/register">
                  <Button size="lg" className="w-full sm:w-auto relative overflow-hidden group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white shadow-lg shadow-blue-900/30 transition-all duration-300">
                ...
                <Link href="#how-it-works">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto border-slate-700 text-slate-300 hover:text-white hover:border-blue-500/50">
                    Learn More
              ...
              <div className="mt-10 flex items-center gap-8">
                <div className="flex flex-col">
                  <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-blue-300 text-transparent bg-clip-text">98%</span>
                  <span className="text-sm text-slate-400">Resolution Rate</span>
                </div>
                <div className="h-10 w-px bg-slate-800"></div>
                <div className="flex flex-col">
                  <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-blue-300 text-transparent bg-clip-text">24hrs</span>
                  <span className="text-sm text-slate-400">Avg. Response Time</span>
                </div>
                <div className="h-10 w-px bg-slate-800"></div>
                <div className="flex flex-col">
                  <span className="text-2xl font-bold bg-gradient-to-r from-blue-400 to-blue-300 text-transparent bg-clip-text">5,000+</span>
            ...
            >
              <div className="absolute -right-20 -top-16 w-64 h-64 rounded-full bg-blue-500/10 opacity-60 blur-3xl"></div>
              <div className="absolute -left-10 -bottom-10 w-40 h-40 rounded-full bg-blue-500/10 opacity-60 blur-3xl"></div>
              
              <div className="bg-slate-900/70 backdrop-blur-sm border border-slate-800/50 shadow-xl shadow-blue-900/20 rounded-2xl overflow-hidden w-full max-w-md mx-auto">
                ...
                <div className="p-6 space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="h-12 w-12 bg-blue-500/20 text-blue-300 rounded-full flex items-center justify-center">
      ...
      <section id="how-it-works" className="py-24 relative">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center mb-16">
            <span className="inline-block px-3 py-1 rounded-full text-sm font-medium bg-blue-900/40 text-blue-200 mb-4 border border-blue-700/40">
              How It Works
            </span>
            <h2 className="text-3xl md:text-4xl font-bold mb-4 bg-gradient-to-r from-blue-200 to-blue-300 bg-clip-text text-transparent">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="bg-slate-900/70 backdrop-blur-sm border border-slate-800/50 rounded-lg p-6 shadow-lg hover:shadow-blue-900/20 hover:border-blue-500/30 transition-all duration-300"
              >
                ...
                <div className="mt-4 h-1 w-10 bg-gradient-to-r from-blue-500 to-blue-400 rounded-full"></div>
              </motion.div>
            ))}
          </div>
          ...
          <div className="mt-12 text-center">
            <Link href="/auth/register">
              <Button size="lg" className="relative overflow-hidden group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white shadow-lg shadow-blue-900/30 transition-all duration-300 px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-slate-900/30 backdrop-blur-sm border border-slate-800/50 rounded-lg p-6 shadow-lg hover:shadow-blue-900/20 hover:border-blue-500/30 transition-all duration-300"
              >
                ...
                <div className="flex items-center">
                  <div className="h-10 w-10 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-300 font-medium text-sm">
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-r from-blue-600/20 to-blue-500/20 backdrop-blur-sm rounded-2xl p-8 md:p-12 shadow-xl border border-blue-500/30 text-center">
            ...
            <Link href="/auth/register">
              <Button size="lg" className="relative overflow-hidden group bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white shadow-lg shadow-blue-900/30 transition-all duration-300 px-10 py-6 text-lg font-medium">
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center gap-2 mb-4">
                <div className="h-8 w-8 rounded-md bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center shadow-sm shadow-blue-900/30">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><Link href="/auth/login" className="text-slate-400 hover:text-blue-400 transition-colors">Log in</Link></li>
                <li><Link href="/auth/register" className="text-slate-400 hover:text-blue-400 transition-colors">Register</Link></li>
                <li><Link href="/petitions" className="text-slate-400 hover:text-blue-400 transition-colors">Browse Petitions</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#" className="text-slate-400 hover:text-blue-400 transition-colors">Contact Us</Link></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-slate-800/60 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              <Link href="#" className="text-slate-500 hover:text-blue-400">
