...
export function SuperAdminDashboardContent({ petitions }: SuperAdminDashboardContentProps) {
  ...
  const filteredPetitions = petitions.filter((petition) => {
    const matchesSearch =
      ...
      (petition.submittedBy && petition.submittedBy.toLowerCase().includes(searchTerm.toLowerCase()))
        ...
        <motion.div variants={itemVariants}>
          <div className="space-y-2">
            ...
            <p className="text-slate-400">
              Monitor all departments and petition activity
            </p>
          </div>
        </motion.div>
        ...
        <motion.div variants={itemVariants}>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <motion.div variants={statsVariants}>
              <Card className="bg-slate-900/60 backdrop-blur-sm border-slate-800/50 overflow-hidden hover:border-purple-500/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(124,58,237,0.1)]">
                ...
                <CardContent className="relative z-10">
                  ...
                  <div className="text-xs text-slate-400 mt-1">All system petitions</div>
                </CardContent>
                <div className="absolute -bottom-4 -right-4 w-16 h-16 rounded-full bg-purple-500/10 flex items-center justify-center">
            ...
            <motion.div variants={statsVariants}>
              <Card className="bg-slate-900/60 backdrop-blur-sm border-slate-800/50 overflow-hidden hover:border-purple-500/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(124,58,237,0.1)]">
                ...
                <div className="absolute -bottom-4 -right-4 w-16 h-16 rounded-full bg-fuchsia-500/10 flex items-center justify-center">
                  <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-fuchsia-300">
                    <path d="M12 2v4"></path>
            ...
            <motion.div variants={statsVariants}>
              <Card className="bg-slate-900/60 backdrop-blur-sm border-slate-800/50 overflow-hidden hover:border-purple-500/30 transition-all duration-300 hover:shadow-[0_0_15px_rgba(124,58,237,0.1)]">
                ...
                <CardContent className="relative z-10">
                  ...
                  <div className="text-xs text-slate-400 mt-1">Urgent attention needed</div>
                </CardContent>
