...
export function StaffPetitionCard({ petition, onUpdateStatus, onViewDetails, isLoading = false }: StaffPetitionCardProps) {
  return (
          ...
          <div>
            ...
            <CardDescription className="text-slate-400 mt-2 flex items-center gap-2">
              ...
              <span className="flex items-center">
                ...
                <span className="text-violet-300">Assigned on: <span className="font-medium">{petition.assigned_date}</span></span>
              </span>
            </CardDescription>
          </div>
