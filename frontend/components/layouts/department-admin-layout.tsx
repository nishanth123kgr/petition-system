...
const navItems = [
  ...
  { id: "petitions", label: "Petitions", icon: FileText, isPro: false },
  { id: "staff", label: "Staff", icon: Users, isPro: false },
      ...
      <header className="bg-slate-900/40 backdrop-blur-xl border-b border-slate-800/60 sticky top-0 z-40 shadow-lg shadow-slate-950/30">
        <div className="container mx-auto px-4 py-3 flex items-center">
          <div className="flex items-center gap-2 mr-4">
            ...
            <Link href="/dashboard/department-admin" className="flex items-center" onClick={() => setActiveTab("dashboard")}>
...
function NavItem({ item, isActive, onClick }: {
  item: { id: string; label: string; icon: any; isPro?: boolean };
  isActive: boolean;
  onClick?: () => void;
}) {
  return (
