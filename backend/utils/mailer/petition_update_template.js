const petitionUpdateTemplate = (petitionTitle, newStatus, petitionId) => {
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="text-align: center;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold; letter-spacing: 1px; color: #ffffff;">PETITION STATUS UPDATE</h1>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td style="padding-bottom: 30px; color: #333333; font-size: 16px; line-height: 24px; text-align: center;">
              <p style="margin: 0; font-size: 18px;">Your petition status has been updated</p>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding-bottom: 30px;">
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 1px solid #e0e0e0; border-radius: 6px; overflow: hidden; background-color: #ffffff;">
                ...
                <tr>
                  <td style="padding: 15px; font-weight: bold; width: 120px; color: #555555; border-right: 1px solid #e0e0e0;">Petition ID:</td>
                  <td style="padding: 15px; color: #333333; font-family: 'Courier New', monospace; font-size: 16px; letter-spacing: 1px; background-color: #f9f9f9;">${petitionId}</td>
                </tr>
                <tr>
                  <td style="padding: 15px; font-weight: bold; width: 120px; color: #555555; border-right: 1px solid #e0e0e0;">Title:</td>
                  <td style="padding: 15px; color: #333333; font-size: 16px;">${petitionTitle}</td>
                </tr>
                <tr>
                  <td style="padding: 15px; font-weight: bold; width: 120px; color: #555555; border-right: 1px solid #e0e0e0;">New Status:</td>
                  <td style="padding: 15px; color: #4a6fdc; font-size: 16px; font-weight: bold;">${newStatus}</td>
                </tr>
              </table>
            </td>
          </tr>
...
export default petitionUpdateTemplate;