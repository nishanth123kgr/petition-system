const petitionAssignedStaffTemplate =  (petitionId, petitionTitle) => {
    return `
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="text-align: center;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold; letter-spacing: 1px; color: #ffffff;">PETITION ASSIGNED</h1>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td style="padding-bottom: 30px; color: #333333; font-size: 16px; line-height: 24px; text-align: center;">
              <p style="margin: 0; font-size: 18px;">You have been assigned a petition.</p>
            </td>
          </tr>
...
export default petitionAssignedStaffTemplate;
