const staffCreationMailTemplate = (departmentName, password) => `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
  <meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
  <title>Staff Admin Confirmation</title>
</head>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr>
            <td style="text-align: center;">
              <h1 style="margin: 0; font-size: 28px; font-weight: bold; letter-spacing: 1px; color: #ffffff;">Staff Confirmation</h1>
            </td>
          </tr>
        </table>
      </td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          ...
          <tr>
            <td style="padding-bottom: 30px; color: #333333; font-size: 16px; line-height: 24px; text-align: center;">
              <p style="margin: 0; font-size: 18px;">You have been added as a staff of ${departmentName} Department</p>
            </td>
          </tr>
...
export default staffCreationMailTemplate;
