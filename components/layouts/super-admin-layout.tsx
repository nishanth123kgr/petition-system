...
import { LayoutDashboard, Users, FileText, BarChart, Settings, LogOut, Building, User, Menu, Shield, ChevronRight } from "lucide-react"
      ...
      <header className="bg-slate-900/40 backdrop-blur-xl border-b border-slate-800/60 sticky top-0 z-40 shadow-lg shadow-slate-950/30">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            <span className="hidden md:block text-sm text-slate-400">Welcome, Super Admin</span>
      ...
      <div className="flex-1 flex flex-col md:flex-row">
        ...
        <main className="flex-1 p-4 md:p-8 md:pt-6 md:ml-64 transition-all duration-300">
          ...
          <div className="mb-6">
            ...
            >
              <Link href="/dashboard/super-admin" className="hover:text-purple-300 transition-colors flex items-center">
...
const navItems = [
  ...
  { href: "/dashboard/super-admin/petitions", label: "All Petitions", icon: FileText },
  { href: "/dashboard/super-admin/departments", label: "Departments", icon: Building },
  { href: "/dashboard/super-admin/users", label: "Users", icon: Users, badge: "New" },
  { href: "/dashboard/super-admin/analytics", label: "Analytics", icon: BarChart },
